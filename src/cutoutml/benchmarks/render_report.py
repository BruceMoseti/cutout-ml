...
def contention_block(report: dict[str, Any]) -> str:
    ...
    rows = [
        ...
        "was doing. The scoring pass is also run from a fixed RNG state so that it does not "
        "depend on the timing work around it - see [Accuracy metrics](#accuracy-metrics).",
        "",
